...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_customers,write_customers,write_script_tags,read_themes,write_themes'),
    ...
    */
    ...
    'webhooks' => [
        ...
        [
            ...
            'address' => env('APP_URL') . '/webhook/domains-create'
        ],
        [
